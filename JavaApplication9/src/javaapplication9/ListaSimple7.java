...
public class ListaSimple7 extends javax.swing.JInternalFrame {
    public class Nodo{
        String codigo;
        String nombre;
        String apellido1;
        ...
        String codigod;
        Nodo sig;
        public Nodo(String cod,String nom,String ape1,String tar,String fec, String tel,String mov,String dir,String fre, String cos, String codd){
            codigo=cod;
            nombre=nom;
            apellido1=ape1;
            tarjeta=tar;
    ...
    void encabezado(){
        ...
        txaRegistro.setText("");
        txaRegistro.append("");
        txaRegistro.append("    N°  CODIGO      TIPO        CLASIFICACION      CANTIDAD          C.TRANSPORTE        C.HOSPEDAJE       C.CRUCERO          C.RENTADORA        C.DESTINO       C.LUGAR       COSTO\n");
        txaRegistro.append("---------------------------------------------------------------------------------------------------------\n");
    ...
    void verdatos(){
        String cod,nom,ape1,tar,fec,tel,mov,dir,fre,cos,codd;
        Nodo aux=ini;
        num=0;
        encabezado();
        while(aux!=null){
           ...
           for(int i=codd.length();i<20;i++){
                codd=codd+" ";
            }
           
            
            txaRegistro.append(numera + "   " + cod+nom+ape1+tar + fec + tel + mov + dir + fre + cos + codd+ "\n");
            aux=aux.sig;
    ...
    Nodo insertarinicio(Nodo inicio,String cod,String nom,String ape1,String tar,String fec,String tel,String mov, String dir,String fre, String cos, String codd){
        Nodo nuevo=new Nodo(cod,nom,ape1,tar,fec,tel,mov,dir,fre,cos,codd);
        nuevo.sig=inicio;
        inicio=nuevo;
        return inicio;
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Cantidad viajeros");
        ...
        jLabel5.setText("Codigo transporte");

        jLabel6.setText("Codigo hospedaje");

        jLabel7.setText("Codigo crucero");
        ...
        jLabel10.setText("Codigo lugar");

        jLabel11.setText("Codigo rentadora");
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
      ...
      String codd=txtcodigod.getText().toUpperCase();

      ini=insertarinicio(ini,cod,nom,ape1,tar,fec,tel,mov,dir,fre,cos,codd);
      limpiarentradas();
      verdatos();
    ...
    private void btnactualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnactualizarActionPerformed
        ...
        pFound.codigod=txtcodigod.getText().toUpperCase();
    ...
    private void btnconsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnconsultarActionPerformed
        ...
        if(cod.equalsIgnoreCase("")){
            ...
            if(pFound!=null){
                ...
                txtcodigod.setText(pFound.codigod);
...
FileReader lector=new FileReader("08 Paquetes.csv");
...
String cadena = texto;
      ...
      String codd=arregloDeCadena[10];
