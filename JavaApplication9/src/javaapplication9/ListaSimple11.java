...
public class ListaSimple11 extends javax.swing.JInternalFrame {
    public class Nodo{
        String codigo;
        String nombre;
        String apellido1;
        String telefono;
        Nodo sig;
        public Nodo(String cod,String nom,String ape1, String tel){
            codigo=cod;
            nombre=nom;
            apellido1=ape1;
            telefono=tel;
    ...
    void encabezado(){
        ...
        txaRegistro.setText("");
        txaRegistro.append("");
        txaRegistro.append("    N°  CODIGO      C.RESERVACION        HABITACION      COSTO\n");
        txaRegistro.append("---------------------------------------------------------------------------------------------------------\n");
    ...
    void verdatos(){
        ...
        while(aux!=null){
            ...
            txaRegistro.append(numera + "   " + cod+nom+ape1+ tel +"\n");
            aux=aux.sig;
    ...
    Nodo insertarinicio(Nodo inicio,String cod,String nom,String ape1,String tel){
        Nodo nuevo=new Nodo(cod,nom,ape1,tel);
        nuevo.sig=inicio;
        inicio=nuevo;
        return inicio;
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Codigo reservacion");
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
      ...
      ini=insertarinicio(ini,cod,nom,ape1,tel);
      limpiarentradas();
      verdatos();
...
FileReader lector=new FileReader("13 Camarotes.csv");
