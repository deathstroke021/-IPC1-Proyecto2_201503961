...
public class ListaSimple8 extends javax.swing.JInternalFrame {
    public class Nodo{
        String codigo;
        String nombre;
        String apellido1;
        ...
        String frecuencia;
        Nodo sig;
        public Nodo(String cod,String nom,String ape1,String tar,String fec, String tel,String mov,String dir,String fre){
            codigo=cod;
            nombre=nom;
            apellido1=ape1;
            tarjeta=tar;
    ...
    void encabezado(){
        ...
        txaRegistro.setText("");
        txaRegistro.append("");
        txaRegistro.append("    N°  CODIGO      C.CLIENTE        PASAJEROS      TIPO          DIAS        MONTO       ENTREGA          DEVOLUCION        CONDICION\n");
        txaRegistro.append("---------------------------------------------------------------------------------------------------------\n");
    ...
    void verdatos(){
        String cod,nom,ape1,tar,fec,tel,mov,dir,fre;
        Nodo aux=ini;
        num=0;
        encabezado();
        while(aux!=null){
            ...
            txaRegistro.append(numera + "   " + cod+nom+ape1+tar + fec + tel + mov + dir + fre +"\n");
            aux=aux.sig;
    ...
    Nodo insertarinicio(Nodo inicio,String cod,String nom,String ape1,String tar,String fec,String tel,String mov, String dir,String fre){
        Nodo nuevo=new Nodo(cod,nom,ape1,tar,fec,tel,mov,dir,fre);
        nuevo.sig=inicio;
        inicio=nuevo;
        return inicio;
    }
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
      ...
      ini=insertarinicio(ini,cod,nom,ape1,tar,fec,tel,mov,dir,fre);
      limpiarentradas();
      verdatos();
...
FileReader lector=new FileReader("10 RentaAutos.csv");
