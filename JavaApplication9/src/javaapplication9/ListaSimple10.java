...
public class ListaSimple10 extends javax.swing.JInternalFrame {
    public class Nodo{
        String codigo;
        String nombre;
        String apellido1;
    ...
    void encabezado(){
        ...
        txaRegistro.setText("");
        txaRegistro.append("");
        txaRegistro.append("    N°  CODIGO      HABITACION        C.RESERVACION      PERSONAS          COSTO               CLASE\n");
        txaRegistro.append("---------------------------------------------------------------------------------------------------------\n");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Codigo reservacion");
...
FileReader lector=new FileReader("12 Habitaciones.csv");
