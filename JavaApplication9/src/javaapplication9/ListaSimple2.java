...
public class ListaSimple2 extends javax.swing.JInternalFrame {
    public class Nodo{
        String codigo;
        String nombre;
        String apellido1;
    ...
    void encabezado(){
        ...
        txaRegistro.setText("");
        txaRegistro.append("");
        txaRegistro.append("    N°  CODIGO      DIRECCION        CUARTOS      DESTINO\n");
        txaRegistro.append("---------------------------------------------------------------------------------------------------------\n");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Cuartos disponibles");
...
FileReader lector=new FileReader("02 HotelesResorts.csv");
