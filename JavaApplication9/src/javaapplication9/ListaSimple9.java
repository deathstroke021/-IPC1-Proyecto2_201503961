...
public class ListaSimple9 extends javax.swing.JInternalFrame {
    public class Nodo{
        String codigo;
        String nombre;
        String apellido1;
    ...
    void encabezado(){
        ...
        txaRegistro.setText("");
        txaRegistro.append("");
        txaRegistro.append("    N°  CODIGO      C.RESERVACION        ASIENTO      CLASE          COSTO\n");
        txaRegistro.append("---------------------------------------------------------------------------------------------------------\n");
...
FileReader lector=new FileReader("11 Asientos.csv");
