...
public class ListaSimple6 extends javax.swing.JInternalFrame {
    public class Nodo{
        String codigo;
        String nombre;
        String apellido1;
        ...
        String frecuencia;
        Nodo sig;
        public Nodo(String cod,String nom,String ape1,String tar, String tel,String dir){
            codigo=cod;
            nombre=nom;
            apellido1=ape1;
            tarjeta=tar;
    ...
    void encabezado(){
        ...
        txaRegistro.setText("");
        txaRegistro.append("");
        txaRegistro.append("    N°  CODIGO      C.CLIENTE        TARJETA      C.TARJETA          SALDO               MONTO\n");
        txaRegistro.append("---------------------------------------------------------------------------------------------------------\n");
    ...
    void verdatos(){
        String cod,nom,ape1,tar,tel,dir;
        Nodo aux=ini;
        num=0;
        encabezado();
        while(aux!=null){
            ...
            txaRegistro.append(numera + "   " + cod+nom+ape1+tar + tel + dir  +"\n");
            aux=aux.sig;
    ...
    Nodo insertarinicio(Nodo inicio,String cod,String nom,String ape1,String tar,String tel, String dir){
        Nodo nuevo=new Nodo(cod,nom,ape1,tar,tel,dir);
        nuevo.sig=inicio;
        inicio=nuevo;
        return inicio;
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Saldo acumulado");

        jLabel8.setFont(new java.awt.Font("Comic Sans MS", 1, 14)); // NOI18N
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel8.setText("Entidad Financiera");

        jLabel11.setText("Monto maximo");
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
      ...
      ini=insertarinicio(ini,cod,nom,ape1,tar,tel,dir);
      limpiarentradas();
      verdatos();
...
FileReader lector=new FileReader("04 EntidadFinanciera.csv");
