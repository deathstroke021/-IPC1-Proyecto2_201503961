...
public class ListaSimple5 extends javax.swing.JInternalFrame {
    public class Nodo{
        String codigo;
        String nombre;
        String apellido1;
    ...
    void encabezado(){
        ...
        txaRegistro.setText("");
        txaRegistro.append("");
        txaRegistro.append("    N°  CODIGO      NOMBRE        DESCRIPCION      PAIS          CIUDAD        DIRECCION       EDAD          INICIO        FUNCION       RECOMENDACIONES       DESTINO\n");
        txaRegistro.append("---------------------------------------------------------------------------------------------------------\n");
...
FileReader lector=new FileReader("07 LugaresE_E.csv");
