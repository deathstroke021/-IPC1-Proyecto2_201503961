...
public class ListaSimple3 extends javax.swing.JInternalFrame {
    public class Nodo{
        String codigo;
        String nombre;
        String apellido1;
    ...
    void encabezado(){
        ...
        txaRegistro.setText("");
        txaRegistro.append("");
        txaRegistro.append("    N°  CODIGO      F.SALIDA        F.LLEGADA      PASAJEROS          DIAS               DESCRIPCION          DESTINO\n");
        txaRegistro.append("---------------------------------------------------------------------------------------------------------\n");
...
FileReader lector=new FileReader("03 Cruceros.csv");
